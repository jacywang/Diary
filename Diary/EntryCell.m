...
+ (CGFloat)heightForEntry:(DiaryEntry *)entry {
    ...
    CGRect boundingBox = [entry.body boundingRectWithSize:CGSizeMake(150, CGFLOAT_MAX) options:(NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin) attributes:@{NSFontAttributeName: font} context:nil];
